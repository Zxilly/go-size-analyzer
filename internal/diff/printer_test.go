...
func TestDiffDisplayNameFallsBackForEmptyPackageName(t *testing.T) {
	assert.Equal(t, "<autogenerated>", diffDisplayName(""))
	assert.Equal(t, "runtime", diffDisplayName("runtime"))
}
